        ...
        public MockedAnimationPatternKeyFrames()
        {
            ...
            [
                new()
                {
                    ...
                    TimeMs = 0,
                    PropertyEdited = LaserAPI.Models.Helper.PropertyEdited.Scale,
                    PropertyValue = 0
                },
                new()
                {
                    ...
                    AnimationPatternUuid = Guid.Parse("a9de1d0b-a623-433e-8a17-57555d3c5e4e"),
                    TimeMs = 0,
                    PropertyEdited = LaserAPI.Models.Helper.PropertyEdited.XOffset,
                    PropertyValue = 0
                },
                new()
                {
                    ...
                    AnimationPatternUuid = Guid.Parse("a9de1d0b-a623-433e-8a17-57555d3c5e4e"),
                    TimeMs = 0,
                    PropertyEdited = LaserAPI.Models.Helper.PropertyEdited.YOffset,
                    PropertyValue = 0
                },
                new()
                {
                    ...
                    AnimationPatternUuid = Guid.Parse("a9de1d0b-a623-433e-8a17-57555d3c5e4e"),
                    TimeMs = 0,
                    PropertyEdited = LaserAPI.Models.Helper.PropertyEdited.Rotation,
                    PropertyValue = 0
                },
                // Starting new timems
                new()
