...
namespace LaserAPITests.MockedModels.Zones
{
    ...
    {
        internal List<SafetyZoneDto> Zones = new();

        public MockedZones()
        {
            SafetyZoneDto zone1 = new()
            {
                MaxLaserPowerInZonePercentage = 50,
                Uuid = Guid.Parse("fc220bc5-68ff-45d8-8e51-d884687e324b"),
                Points = new List<SafetyZonePointDto>
                {
                    new()
                    {
                        SafetyZoneUuid = Guid.Parse("fc220bc5-68ff-45d8-8e51-d884687e324b"),
            ...
            SafetyZoneDto zone2 = new()
            {
                MaxLaserPowerInZonePercentage = 40,
                Uuid = Guid.Parse("c9ba9637-96c6-455d-be72-849ce86438a8"),
                Points = new List<SafetyZonePointDto>
                {
                    new()
                    {
                        SafetyZoneUuid = Guid.Parse("c9ba9637-96c6-455d-be72-849ce86438a8"),
            ...
            SafetyZoneDto zone3 = new()
            {
                ...
                Points = new List<SafetyZonePointDto>
                {
                    new()
                    {
                        SafetyZoneUuid = Guid.Parse("37a8eb34-7b11-42f9-ba85-cdc778d48a3c"),
            ...
            SafetyZoneDto zone4 = new()
            {
                ...
                Points = new List<SafetyZonePointDto>
                {
                    new()
                    {
                        SafetyZoneUuid = Guid.Parse("e4c8cea7-9722-4f1f-bbd1-9c64f7da7e2e"),
